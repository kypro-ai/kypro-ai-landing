...
Tested on TSLA daily bars from Jan 2020 to Dec 2024. Includes commission of $0.005/share. Slippage modeled at 0.05% per trade. Survivorship bias: N/A (single stock). Curve-fitting risk is moderate — parameters were not optimized, but chosen from common technical analysis literature.`,
    ...
    currentSignal: {
      ...
      note: "TSLA $417, below 20-day high $431. RSI=56. No breakout trigger.",
    },
    price: 4.99,
...
Tested on TSLA 5-minute bars from Jan 2023 to Dec 2024. Commission: $0.005/share. Slippage: 1 tick ($0.01). Market impact modeled conservatively. Win rate is high because targets are tight relative to TSLA's intraday range.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "TSLA $417. Intraday signal — market hours only. RSI=56, 5-SMA=$410.",
    },
    price: 4.99,
...
Tested on TSLA 5-minute bars from Jun 2022 to Dec 2024. Pattern detection is algorithmic — parameters for "triple touch" (3 touches, 0.3% tolerance, 2-hour window) were chosen from classical chart pattern literature. Commission and slippage included.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "TSLA $417. No triple-top pattern detected. RSI=56. Resistance at $431.",
    },
    price: 4.99,
...
Tested on SPY daily bars from Jan 2015 to Dec 2024. This is a counter-trend strategy — win rate is moderate but reward:risk is favorable when it triggers. The seasonal filter significantly improved performance.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "SPY $693. RSI=55, %%B=0.72. Mid-range, no setup.",
    },
    price: 2.99,
...
Tested on QQQ daily bars from Jan 2005 to Dec 2024. Only 14 round-trip signals in 20 years — very low frequency. 4 major winners that captured multi-year bull runs. The 2022 bear market was avoided entirely.`,
    ...
    currentSignal: {
      ...
      confidence: 0.1,
      lastUpdated: "2026-02-25",
      note: "QQQ $617. Death cross: 20-SMA < 50-SMA. RSI=57.",
    },
    price: 2.99,
...
Tested on NVDA daily bars from Jan 2020 to Dec 2024. NVDA's AI-driven regime (2023–2024) produced outsized winners. Pre-2023 performance was more modest. Strategy benefits from NVDA's high beta and narrative-driven moves.`,
    ...
    currentSignal: {
      ...
      confidence: 0.65,
      lastUpdated: "2026-02-25",
      note: "NVDA $196 broke 20-day high, ATR expanding. RSI=74. Breakout.",
    },
    price: 4.99,
...
Tested on BTC/USD daily bars from Jan 2018 to Dec 2024. Captures the 2020–2021 bull run and 2023–2024 recovery. Avoids the worst of 2022 bear market. CAGR is high but drawdowns are significant — this is crypto.`,
    ...
    currentSignal: {
      ...
      confidence: 0.1,
      lastUpdated: "2026-02-25",
      note: "BTC $68,530 below 50-SMA ($79,667). RSI=54. No long setup.",
    },
    price: 4.99,
...
Tested on GLD/VIX daily data from Jan 2010 to Dec 2024. Triggers 3–5 times per year on average. Works best during sudden market drops (COVID crash, SVB crisis). Less effective during slow grinding bear markets.`,
    ...
    currentSignal: {
      ...
      confidence: 0.4,
      lastUpdated: "2026-02-25",
      note: "GLD $473 above 50-SMA ($435). VIX=18 normal. Gold uptrend. RSI=57.",
    },
    price: 2.99,
...
Tested on VIX/VIX futures data from Jan 2012 to Dec 2024. Excludes the Feb 2018 XIV blowup (which would have been caught by the 20% stop). Win rate is high because VIX mean-reverts reliably, but the losers can be large.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "VIX 17.9. Normal. 20-SMA=18.9. Strategy inactive.",
    },
    price: 2.99,
...
Tested from Jan 2015 to Dec 2024 (BTC available from 2015). 120 monthly observations. Tax efficiency is low due to monthly turnover — best suited for tax-advantaged accounts. The strategy underperforms in whipsaw environments (2018, 2022 H1) but captures strong trends (2017, 2020–2021, 2023–2024).`,
    ...
    currentSignal: {
      ...
      confidence: 0.55,
      lastUpdated: "2026-02-25",
      note: "3-month momentum: GLD: +24.5%; EEM: +19.7%; SPY: +4.0%; QQQ: +2.0%; TLT: +1.0%; BTC: -21.4%. Allocation: GLD, EEM, SPY. Next rebalance Mar 1.",
    },
    price: 4.99,
...
Tested on AAPL daily bars from Jan 2018 to Dec 2024. Commission: $0.005/share. Slippage: 0.03%. Support levels recalculated on a rolling 90-day window. The strategy avoids earnings weeks to reduce gap risk.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "AAPL $274. RSI=48, %%B=0.73. Mid-range, no setup.",
    },
    price: 2.99,
...
Tested on AMZN earnings events from Q1 2018 to Q4 2024 (28 earnings reports). Includes after-hours gap modeling. Slippage is higher around earnings — modeled at 0.10%.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "AMZN $211. Next earnings ~late Apr 2026. RSI=30. No pre-earnings setup.",
    },
    price: 4.99,
...
Tested on META daily/intraday bars from Jan 2019 to Dec 2024. Gaps are filtered for news catalysts. Commission and slippage modeled at 0.05% round trip.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "META $654. No qualifying gap (last: +0.5%). RSI=43.",
    },
    price: 2.99,
...
Tested on MSFT daily bars from Jan 2016 to Dec 2024. Low trade frequency — only triggers on clean pullbacks to the 50-day SMA in trending markets.`,
    ...
    currentSignal: {
      ...
      confidence: 0.1,
      lastUpdated: "2026-02-25",
      note: "MSFT $401 below 50-SMA. ADX=43. RSI=43.",
    },
    price: 2.99,
...
Tested on AMD daily bars from Jan 2020 to Dec 2024. AMD's massive AI rally in 2023–2024 produced outsized winners. Pre-2023 performance was more modest with higher drawdowns.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "AMD $211. ATR=10.4(avg=11.0). BB width=0.089. RSI=57.",
    },
    price: 4.99,
...
Tested on IWM/SPY monthly data from Jan 2010 to Dec 2024. 180 monthly observations. Turnover is moderate (switches ~4–6 times per year). Tax drag should be considered for taxable accounts.`,
    ...
    currentSignal: {
      ...
      confidence: 0.55,
      lastUpdated: "2026-02-25",
      note: "IWM $265. IWM +10.7% vs SPY +4.0% (3mo). RSI=56. Small-cap favored.",
    },
    price: 2.99,
...
Tested on DIA daily bars from Jan 2012 to Dec 2024. Breadth data from Dow 30 component screening. The breadth filter reduced false signals by ~35% compared to raw MA crossover.`,
    ...
    currentSignal: {
      ...
      confidence: 0.55,
      lastUpdated: "2026-02-25",
      note: "DIA $495. 20-SMA ($494) > 50-SMA ($490). Bullish. RSI=51.",
    },
    price: 2.99,
...
Tested on XLF daily bars + yield curve data from Jan 2015 to Dec 2024. Yield curve data sourced from FRED. The earnings overlay improved win rate by ~5% over yield curve signals alone.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "XLF $52 below 50-SMA. RSI=38. No setup.",
    },
    price: 2.99,
...
Tested on XLE/CL daily data from Jan 2016 to Dec 2024. Oil correlation data ensures the strategy only trades when the macro relationship holds. 2020 COVID crash produced the max drawdown.`,
    ...
    currentSignal: {
      ...
      confidence: 0.5,
      lastUpdated: "2026-02-25",
      note: "XLE $55 above 50-SMA. RSI=63. USO 3mo: +13.2%. Energy bullish.",
    },
    price: 4.99,
...
Tested on TLT daily bars + Fed funds futures data from Jan 2015 to Dec 2024. The rate expectation filter is crucial — without it, the strategy catches falling knives during hiking cycles.`,
    ...
    currentSignal: {
      ...
      confidence: 0.3,
      lastUpdated: "2026-02-25",
      note: "TLT $90. RSI=81 leaning overbought but not extreme. %%B=0.80.",
    },
    price: 2.99,
...
Tested on ETH/USD daily bars from Jan 2020 to Dec 2024. The 21-EMA was chosen over the 50-SMA because crypto trends are faster and shorter-lived. The BTC macro filter avoided the worst of the 2022 bear market.`,
    ...
    currentSignal: {
      ...
      confidence: 0.1,
      lastUpdated: "2026-02-25",
      note: "ETH $2,060 below 50-SMA ($2,539). RSI=59. No long setup.",
    },
    price: 4.99,
...
Tested on SOL/USD daily bars from Jan 2021 to Dec 2024. SOL's massive rally in late 2023 and 2024 produced outsized returns. The 2022 FTX collapse drawdown was partially avoided by the momentum filter. High CAGR comes with high volatility.`,
    ...
    currentSignal: {
      ...
      confidence: 0.65,
      lastUpdated: "2026-02-25",
      note: "SOL $89 broke 14-day high $89. RSI=62, MACD+. Breakout.",
    },
    price: 4.99,
...
Tested on BTC/ETH ratio daily data from Jan 2020 to Dec 2024. Weekly rebalancing with 0.1% slippage per leg. The strategy is dollar-neutral — overall crypto market direction doesn't affect returns.`,
    ...
    currentSignal: {
      ...
      confidence: 0.3,
      lastUpdated: "2026-02-25",
      note: "BTC/ETH ratio 33.3, Z=+0.8. Normal range. BTC=$68,530, ETH=$2,060.",
    },
    price: 4.99,
...
Tested on CL/USO daily data + EIA inventory reports from Jan 2017 to Dec 2024. EIA data was sourced from the U.S. Energy Information Administration. Slippage on CL futures modeled at 1 tick.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "USO $80. ATR=1.81 (avg=1.73). Normal vol. RSI=57. No signal.",
    },
    price: 2.99,
...
Tested on Gold/Silver ratio monthly data from Jan 2010 to Dec 2024. Very low trade frequency (~2–3 round trips per year. The 252-day lookback window captures multi-year regime shifts.`,
    ...
    currentSignal: {
      ...
      confidence: 0.3,
      lastUpdated: "2026-02-25",
      note: "Gold/Silver ratio 5.9, Z=-0.3. Normal. GLD=$473, SLV=$80.",
    },
    price: 2.99,
...
Tested on NG/UNG daily data + NOAA weather data from Jan 2015 to Dec 2024. Weather forecasts are inherently uncertain beyond 7–10 days. The strategy uses a 14-day forecast but assigns higher weight to the 7-day window.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "UNG $12. Late Feb — heating season winding down. RSI=22. Next seasonal window: Oct injection season.",
    },
    price: 2.99,
...
Tested on DXY daily bars + Fed funds futures from Jan 2015 to Dec 2024. The rate expectation filter reduced false signals by ~40% compared to technical-only approach.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "DXY $98. RSI=49, %%B=0.64. Mid-range, no setup.",
    },
    price: 2.99,
...
Tested on XLU/XLF/TLT + 10Y Treasury yield monthly data from Jan 2012 to Dec 2024. Rate regime classification uses 3-month and 6-month rate of change. The cash override triggered twice (2020 COVID crash, 2022 everything-selloff).`,
    ...
    currentSignal: {
      ...
      confidence: 0.5,
      lastUpdated: "2026-02-25",
      note: "Rates falling: TLT 3mo +1.0%. XLU (+7.0%) > XLF (+0.3%). Utilities favored.",
    },
    price: 2.99,
...
Tested on SPY daily bars + CNN Fear & Greed Index from Jan 2012 to Dec 2024. Extreme fear signals occur 2–5 times per year. The strategy is high conviction — it trades rarely but with large position sizes.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "Neutral sentiment — VIX=18. SPY $693, RSI=55. No extreme fear/greed.",
    },
    price: 2.99,
...
Tested on all 8 assets monthly data from Jan 2015 to Dec 2024 (120 monthly observations). BTC included from 2015. The volatility adjustment improves risk-adjusted returns by ~15% vs raw momentum. Tax efficiency is moderate — best suited for tax-advantaged accounts.`,
    ...
    currentSignal: {
      ...
      confidence: 0.5,
      lastUpdated: "2026-02-25",
      note: "Global 3-month: GLD: +24.5%; EEM: +19.7%; EFA: +16.0%; SPY: +4.0%; TLT: +1.0%; BTC: -21.4%. Top 3: GLD, EEM, EFA. Next rebalance Mar 1.",
    },
    price: 4.99,
...
Tested on META daily bars from Jan 2019 to Dec 2024. The 2023 "year of efficiency" rally was a textbook breakout captured by this strategy. OBV filter eliminated ~40% of false breakouts compared to price-only signals.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "META $654 below 20-day high $738. RSI=43. OBV flat. No breakout.",
    },
    price: 4.99,
...
Tested on MSFT daily bars + dividend calendar from Jan 2016 to Dec 2024 (36 dividend cycles). Win rate is high because MSFT tends to recover ex-div drops quickly in bull markets. The earnings filter eliminated 2 losing trades over the test period.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "MSFT $401. Next ex-div expected ~mid Mar 2026. RSI=43. Approaching capture window.",
    },
    price: 2.99,
...
Tested on SPY options chain data from Jan 2019 to Dec 2024 (monthly cycles). Credit and debit modeled at mid-price with 0.02 slippage per leg. The 50% profit-take rule significantly improved risk-adjusted returns vs holding to expiration.`,
    ...
    currentSignal: {
      ...
      confidence: 0.5,
      lastUpdated: "2026-02-25",
      note: "SPY $693. VIX=18, RSI=55. Moderate IV — iron condor setup favorable. IV Rank moderate.",
    },
    price: 3.99,
...
Tested on QQQ/SPY relative data from Jan 2015 to Dec 2024. Weekly rebalancing with 0.03% slippage. The breadth filter reduced whipsaw exits by ~30% compared to ratio-only signals.`,
    ...
    currentSignal: {
      ...
      confidence: 0.35,
      lastUpdated: "2026-02-25",
      note: "QQQ $617. SPY leading: +4.0% vs QQQ +2.0% (3mo). RSI=57. Tech rotation weak.",
    },
    price: 2.99,
...
Tested on IWM daily bars from Jan 2016 to Dec 2024. Small-cap breakouts have lower win rates than large-cap but higher magnitude when they work. The relative underperformance filter is key — it ensures entry only when catch-up potential exists.`,
    ...
    currentSignal: {
      ...
      confidence: 0.4,
      lastUpdated: "2026-02-25",
      note: "IWM $265. BB squeeze forming (width=0.010). RSI=56. Watching for breakout.",
    },
    price: 3.99,
...
Tested on XLE/CL daily data from Jan 2017 to Dec 2024. The divergence filter identifies genuine dislocations rather than structural regime shifts. Average hold period is 11 days.`,
    ...
    currentSignal: {
      ...
      confidence: 0.3,
      lastUpdated: "2026-02-25",
      note: "XLE $55. RSI=63 leaning overbought but not extreme. %%B=0.72.",
    },
    price: 2.99,
...
Tested on Dow 30 components + dividend data from Jan 2010 to Dec 2024. Annual turnover is ~30–50% (3–5 Dogs change each year). Tax efficiency is moderate due to annual rebalancing. Strategy has beaten the Dow index in ~60% of years.`,
    ...
    currentSignal: {
      ...
      confidence: 0.55,
      lastUpdated: "2026-02-25",
      note: "DIA $495. 2025 Dogs selected Dec 31, 2024. Current holding period. Annual strategy — hold through Dec 31, 2025.",
    },
    price: 2.99,
...
Tested on ARKK/QQQ daily data from Nov 2014 (ARKK inception) to Dec 2024. The dual momentum framework avoided most of the 2022 drawdown. High CAGR is driven by the 2020 rally; post-2020 performance is more modest.`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "ARKK $74. 3-mo: -4.2% negative. Underperforming QQQ (+2.0%). RSI=58. No momentum.",
    },
    price: 3.99,
...
Tested on EEM/DXY/SPY daily data from Jan 2015 to Dec 2024. The dollar filter is the most important variable — EM performance is highly correlated with USD weakness.`,
    ...
    currentSignal: {
      ...
      confidence: 0.55,
      lastUpdated: "2026-02-25",
      note: "EEM $63 above 50-SMA. DXY=98 weakening (below 50-SMA 98). EM favorable. RSI=76.",
    },
    price: 2.99,
...
Tested on BTC/USD data spanning 3 halving cycles (2012, 2016, 2020). The 2024 cycle is in progress. Average post-halving peak return: ~8× from halving-day price (declining each cycle: 100×, 30×, 8×). Sample size is small (3 cycles) — statistical significance is limited.`,
    ...
    currentSignal: {
      ...
      confidence: 0.35,
      lastUpdated: "2026-02-25",
      note: "BTC $68,530. 22 months post-halving. Below 50-SMA — cycle may be peaking. RSI=54.",
    },
    price: 4.99,
...
Tested on ETH/USD + DeFi TVL data from Jun 2020 to Dec 2024. TVL data sourced from DeFi Llama. The correlation filter avoided false signals during periods when ETH traded on macro factors rather than DeFi fundamentals.`,
    ...
    currentSignal: {
      ...
      confidence: 0.3,
      lastUpdated: "2026-02-25",
      note: "ETH $2,060. BTC leading 3-mo: BTC -21.4% vs ETH -29.1%. RSI=59. Waiting for ETH outperformance.",
    },
    price: 4.99,
...
- Maximum position size: 5% of portfolio in any single crypto trade`,
    ...
    currentSignal: {
      ...
      confidence: 0,
      lastUpdated: "2026-02-25",
      note: "BTC $68,530. RSI=54 — neutral crypto sentiment. No extreme fear/greed.",
    },
    price: 4.99,
